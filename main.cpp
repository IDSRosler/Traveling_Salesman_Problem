...
void arvore_ger_minima(int **grafo, int vert_inicial, int *arv_min, int n_vertices);
...
//    grafo[3][2] = 30;
    ...
    arvore_ger_minima(grafo, vertice_inicial, arv_min, n_vertices);
    
    cout << "Arvore minima:\t";
    for (int i = 0; i < n_vertices; i++) {
        cout << grafo[arv_min[i]][i] << "\t";
    }
